...
const Movie = () => {
    return (
        <>
        <MovieHero />
        {/* <div className="my-12 container px-2 lg:w-1/2 lg:ml-56">
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="flex items-start gap-4 bg-yellow-100 border-yellow-400 border-dashed border-2 rounded-lg p-3 w-96">
